...
public class T04_images2 {
	...
	private void initialize() {
		...
		lblImg3.setIcon(new ImageIcon(T04_images2.class.getResource("/t4_WindowBuilder/images/4.jpg")));
		lblImg3.setBounds(497, 10, 229, 392);
		pn2.add(lblImg3);
		
		lblImg4 = new JLabel("New label");
		lblImg4.setIcon(new ImageIcon(T04_images2.class.getResource("/t4_WindowBuilder/images/5.jpg")));
